...
<html lang="en">
  <head>
    ...
    <title>${application.applicationName} - Spring Report</title>
    ...
    <div class="container" role="main">
        <div class="row">
          <div class="page-header page-header-no-border">
            <h1>Spring Report <span class="slash">/</span><small style="margin-left: 20px; font-weight: 100;">${application.applicationName}</small></h1>
